...
## Using PEM files
```scala
val certificationAuthority = PEM.certificate(PEM.fromFile("ca.crt"))
val myCertificate = PEM.certificate(PEM.fromFile("mycert.crt"))
val keyPair = PEM.keyPair(PEM.fromFile("mykey.key"))
