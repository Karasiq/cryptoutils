...
```scala
val verifier = CertificateVerifier(ca.certificate) // Or from java trust store: CertificateVerifier.fromTrustStore(CertificateVerifier.trustStore("example-trust.jks"))
